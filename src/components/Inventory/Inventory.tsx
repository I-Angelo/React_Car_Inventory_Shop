...
//'withRouter helps the app communicate properly with the browser
...
export const Inventory = withRouter(( props:InventoryProps ) => {
    ...
    return (
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}> {/* We are using MUI to make another navbar */} {/* clsx switches the classes depending 
                                                                                                        on what is going on like an if statement, in this case whether the side drawer is open or closed*/}
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Vehicle</Button>
